...
class purchase_requisition_group(osv.osv_memory):
    ...
    _description = "Request Product Merge for purchase requisition"
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form',
        ...
        if context.get('active_model','') == 'request.product' and len(context['active_ids']) < 1:
    ...
    def merge_request(self, cr, uid, ids, context=None):
        ...
        allorders = request_obj.do_merge1(cr, uid, context.get('active_ids',[]), context)
